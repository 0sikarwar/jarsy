...
const HeroSection = () => {
  return (
    <div className="flex justify-center w-screen px-3 py-4 text-TextColor bg-HeaderBg text-center h-[480px] relative">
      <div className="absolute h-full w-full top-0 z-0 before:absolute before:left-0 before:right-0 before:top-0 before:z-10 before:h-full before:w-full before:bg-black before:opacity-45">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center z-[1] h-full justify-center">
        ...
        <Text2Xl className="font-semibold md:leading-normal tracking-wider">
          ...
          <span className="text-[#ff3c6d]">style</span>. Our shoes are designed
          & proudly <span className="text-sky-400">made in India</span> using{" "}
          <span className="text-[#ffc899]">high-quality</span> materials to help
          you walk with <span className="text-[#50c878]">confidence</span> and{" "}
