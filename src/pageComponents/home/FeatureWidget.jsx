...
const FeatureWidget = ({
  ...
  return (
    <Wrapper className={`relative ${wrapperClass}`}>
      <div
        className="w-full h-[500px] absolute bottom-0 md:bottom-auto md:top-1/2 md:transform md:-translate-y-1/2"
        style={{ backgroundColor: color }}
      />
      <Container
        className={`flex mt-4 gap-2 z-[1] flex-col relative px-6 ${
      ...
      >
        <div className="h-auto w-4/5 m-auto md:md-0 md:h-[600px] md:w-auto max-w-[600px] flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
          <Image src={img} alt="Jarsy shoes and sneaker" objectFit="contain" />
        </div>
        <div className="flex flex-col justify-center leading-normal align-center w-4/5 md:w-1/2 m-auto md:m-0">
          <div className="">
            ...
            <Text className="leading-normal mt:2 md:mt-4 md:w-[90%] mb-10 md:mb-0">
              {desc}
            </Text>
          </div>
        </div>
