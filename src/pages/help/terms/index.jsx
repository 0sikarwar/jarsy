...
const TermsAndConditions = () => (
  <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <div className="space-y-4 text-gray-800">
      ...
      <p>
        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name jarsy.in (&apos;Website&apos;), including the related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).
      </p>
      <p>
        The Platform is owned by Jarsy, a company incorporated under the Companies Act, 1956 with its registered office at Shop No 7, Prem Chaudhary Market Panchkula Ramgarh, Panchkula, India (hereinafter referred to as ‘Platform Owner’, &apos;we&apos;, &apos;us&apos;, &apos;our&apos;).
      </p>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">Terms of Use</h2>
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li>
          All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Panchkula and Haryana.
        </li>
        <li>
