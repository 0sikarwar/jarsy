...
const PrivacyPolicy = () => (
  <div className="max-w-3xl mx-auto p-6">
    ...
    <h2 className="text-xl font-semibold mt-4 mb-2">Sharing</h2>
    <p className="mb-4">
    ...
    <h2 className="text-xl font-semibold mt-4 mb-2">Security Precautions</h2>
    <p className="mb-4">
    ...
    <h2 className="text-xl font-semibold mt-4 mb-2">Data Deletion and Retention</h2>
    <p className="mb-4">
    ...
    <h2 className="text-xl font-semibold mt-4 mb-2">Grievance Officer</h2>
    <p className="mb-2">
      <strong>Name of the Officer:</strong> [Insert Name of the Officer]
      <br />
      <strong>Designation:</strong> [Insert Designation]
      <br />
      <strong>Company Name:</strong> Jarsy
      <br />
      <strong>Address:</strong> Shop No 7, Prem Chaudhary Market, Panchkula Ramgarh, Panchkula, India
      <br />
      <strong>Contact us:</strong> [Insert Email or Phone]
      <br />
